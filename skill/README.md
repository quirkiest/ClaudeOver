# ClaudeOver skill (`@be/claude`) v0.2.2 · deploy v0.3.2

| Component | Version |
|---|---|
| skill (`claude/`) | **0.2.2** (ClaudeOver menu tile; new icon) |
...
1. shows a panel: **ClaudeOver v0.2.2** with the instructions,
